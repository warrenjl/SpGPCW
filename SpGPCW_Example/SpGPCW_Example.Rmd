...
sigma2_theta_true<-0.35
phi_theta_true<-0.01
sigma2_eta_true<-0.10
phi_eta_true<-0.10
Sigma_theta_true<-sigma2_theta_true*chol2inv(chol(temporal_corr_fun(m, phi_theta_true)[[1]]))
Sigma_eta_true<-sigma2_eta_true*chol2inv(chol(temporal_corr_fun(m, phi_eta_true)[[1]]))
...
results<-SpGPCW(mcmc_samples = 10000,
                ...
                metrop_var_phi_theta_trans = 1.00,
                metrop_var_rho_trans = 1.4,
                metrop_var_phi_eta_trans = 0.15)
```
